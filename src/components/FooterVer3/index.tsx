            ...
            items: [
                {
                    ...
                    )}:  ${formatPhoneNumber(phoneHotline)}`,
                    type: "NUMBER",
                    url: `${phoneHotline}`,
                },
                {
        ...
        switch (item.type) {
            ...
            case "APP":
                return setOpenPopup({
                    ...
                    content: "",
                    child: (
                        <div className="footer-pop-child">
                            ...
                            <img
                                src={item.qrCode}
                                alt=""
                                className="footer-pop-child-qr-code"
                            />
                        </div>
                    ),
                });
                ...
                <div className={styles.footerCnt}>
                        ...
                        <div className={styles.footerLeftTop}>
                            {data_footer.map((item, index) => (
                                <div key={index} className={styles.wrap}>
                                    <div className={styles.footerCntItem}>
                                        <div
                                            className={
                                                styles.footerCntItemTitle
                                            }
                                        >
                                            {item.title}
                                        </div>
                    ...
                    <div className={styles.footerRight}>
                        <div className={styles.wrap}>
                            <>
                                {/* <div className={styles.footerCntItemTitle}>
                                ...
                                >
                                    {payment.map((item: any, index: number) => (
                                        <div
                                            key={index}
                                            className={`${styles.socialItemMethod} ${styles.socialItem}`}
                                        >
                                            <div
                                ...
                                <div
                                    className={styles.footerCntItemTitle}
                                >
                                ...
                                <div className={styles.socialList}>
                                    {app.map((item: any, index: number) => (
                                        <div
                                            ...
                                            className={`${styles.socialItemImg} ${styles.cursorPointer}`}
                                        >
                                            <img src={item.img} alt="" />
                                        </div>
                                    ))}
                        ...
                        <div className={styles.wrap}>
                            <>
                  <div className={`${styles.footerCntItemTitle} ${styles.connect_size}`}>
                                ...
                                <div
                                    className={`${styles.footerCntItemTitle} ${styles.dowload_size}`}
                                >
                                    {t("footer.download_app")}
                                </div>
                                <div className={styles.downApp}>
                                    <div className={styles.downAppQr}>
                                        <img src={img.qrCode} alt="" />
                                    </div>
                                    <div className={styles.downAppWrap}>
                                        {downList.map(
                                            (item: any, index: number) => (
                                                <div
                                                    key={index}
