    ...
    <>
      <div className={style.com_container}>
        <div className={style.com_container_left}>
          <div className={style.cate_chanel}>
            <NavLink
              activeClassName={
                path === "trang-chu" ? style.cate_chanel_item_act : ""
              }
              className={style.cate_chanel_item}
            ...
            <NavLink
              activeClassName={path === "nhom" ? style.cate_chanel_item_act : ""}
              className={style.cate_chanel_item}
